...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Sammle alle aktuell verwendeten Bilder
    $usedImages = [];
    ...
    // Lösche ungenutzte Bilder aus dem Ordner
                ...
                <div class="editor-grid">
                    ...
                    <div>
                        ...
                        <div class="toolbar">
                            ...
                            <button type="button" class="tool-btn" onclick="wrapText(this,'![Bildbeschreibung](',')')">Image</button>
                        </div>
